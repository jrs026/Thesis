...
% Unsupervised alignment chapter begins here
...
\label{sec:turk_data}
Our pruning strategy is roughly based on that of \newcite{Munteanu05}. Sentence
...
\newcite{Post12}.\footnote{This is the same parallel corpus used to create the
